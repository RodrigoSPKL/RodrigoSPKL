                                ...
                                <div class="card shadow mb-1 col-sm-12">
                                    <div class="card-header py-2 px-8">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form enctype="multipart/form-data" class="user" method="POST" action="/editar-dentistas/{{$dentista->id}}">
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" id="nome" name="nome" value ="{{$dentista->name}}" required="" >
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="email">Email <span data-toggle='tooltip' title="Campo obrigatório.">*</span></label>
                                                        <input type="email" class="form-control" id="email" name="email"  value ="{{$dentista->email}}" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-0 mb-sm-2">                                         
                                                        <label for="cpf">CRO</label>
                                                        <input type="text" class="form-control" name="cro" id="cro" maxlength="11"  value ="{{$dentista->cro}}" required=""/>
                                                    </div>
                                                    <div class="col-sm-6 mb-0 mb-sm-2">                                         
                                                        <label for="cpf">CRO UF</label>
                                                        <input type="text" class="form-control" name="cro_uf" id="cro_uf" maxlength="2"  value ="{{$dentista->cro_uf}}" required="" style="text-transform: uppercase;"/>
                                                    </div>
                                                </div>
