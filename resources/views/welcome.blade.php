                                            ...
                                            <table id="example" class="table table-striped responsive nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> {{$dentista->cro}}</td>
                                                        <td style="text-transform: uppercase;"> {{$dentista->cro_uf}}</td>
                                                        <td> <a href="/mostra-especialidadesAtb/{{$dentista->id}}" style="color: blue;"class='btn btn-sucess btn-xs'><span ></span> Especialidades</a></td>
                                                        <td> <a href="/excluir-dentistas/{{$dentista->id}}" class="btn btn-danger" ><span class="glyphicon glyphicon-remove"></span> excluir</a></td>
                                                        <td> <a href="/editar-dentistas/{{$dentista->id}}" class="btn btn-primary" ><span class="glyphicon glyphicon-remove"></span> Editar</a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>       
