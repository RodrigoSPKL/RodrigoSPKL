                            ...
                            <div class="row">
                                ...
                                <div class="card shadow mb-1 col-sm-12">
                                    <div class="card-header py-2 px-8">
                                        ...
                                        <form enctype="multipart/form-data" class="user" method="POST" action="/editar-especialidade/{{$Especialidade->id}}">
                                            @csrf
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" id="nome" name="nome" value="{{$Especialidade->name}}" required="" >
                                                </div>                                   
                                            </div>
