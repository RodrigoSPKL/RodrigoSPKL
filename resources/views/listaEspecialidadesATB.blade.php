            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        <span><a href="/adicionar-especialidade/{{$especialidades_id[0]->dentista_id}}" class="btn btn-outline-secondary" > Atrubuir Especialidade</a></span>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <div class="col-sm-12 mb-3 mb-sm-0">
                                                    ...
                                                    <a href="/adicionar-especialidade/{{$especialidades_id[0]->dentista_id}}" class="btn btn-outline-success btn-lg">Atrubuir Especialidade</a>
                                                </div>
                                            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                            <h2 style="display: none;">{{$id = $especialidades_id[0]->dentista_id."-".$especialidade->id}}</h2>
                                                            <a href="/desvincularESP/{{$id}}" class="btn btn-danger " ><span class="glyphicon glyphicon-remove"></span>Desvincular</a>
                                                          </div></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
