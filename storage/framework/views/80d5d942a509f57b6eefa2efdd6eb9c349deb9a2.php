            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        <span><a href="/mostra-especialidades" class="btn btn-outline-secondary" >Listar</a></span>
                            ...
                            <div class="row">
                                ...
                                <div class="card shadow mb-1 col-sm-12">
                                    <div class="card-header py-2 px-8">
                                        <h6 class="m-0 font-weight-bold text-primary">Adicionar Especialidade</h6>
                                    </div>
                                        <div class="card-body">
                                            <!--Espaço para a listagem-->
                                         
                                        <form enctype="multipart/form-data" class="user" method="POST" action="/adicionar-especialidade">
                                            <?php echo csrf_field(); ?>

                                            
                                            <input style="display: none;" type="text" name="idUser"  value="<?php echo e($idDentista); ?>"> 
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <select class="form-select form-select-lg mb-3" name="especialidade">
                                                            ...
                                                            <?php $__currentLoopData = $Especialidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Especialidade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value='<?php echo e($Especialidade->id); ?>'><?php echo e($Especialidade->name); ?></option>
...
<?php /**PATH C:\xampp\htdocs\crudDentistas1\resources\views//addEspecialidadeUser.blade.php ENDPATH**/ ?>