...
<body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#7093DB; !Important;">
                ...
                <!-- Sidebar - Brand -->
                <a data-toggle="tooltip" data-placement="right" title="Sistema Integrado de Proteção de Dados" class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                            ...
                            <div class="row">
                                ...
                                <div class="card shadow mb-1 col-sm-12">
                                    <div class="card-header py-2 px-8">
                                        ...
                                        <form enctype="multipart/form-data" class="user" method="POST" action="/editar-especialidade">
                                            <?php echo csrf_field(); ?>
