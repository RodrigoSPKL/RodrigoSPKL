            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        <span><a href="/adicionar-especialidade/<?php echo e($especialidades_id[0]->dentista_id); ?>" class="btn btn-outline-secondary" > Atrubuir Especialidade</a></span>
                            ...
                            <div class="row">
                                ...
                                <div class="card shadow mb-1 col-sm-12">
                                    <div class="card-header py-2 px-8">
                                        <h6 class="m-0 font-weight-bold text-primary">Lista Especialidades</h6>
                                    </div>
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <div class="col-sm-12 mb-3 mb-sm-0">
                                                    
                                                    <a href="/adicionar-especialidade/<?php echo e($especialidades_id[0]->dentista_id); ?>" class="btn btn-outline-success btn-lg">Atrubuir Especialidade</a>
                                                </div>
                                            </div>
                                            ...
                                            <table id="example" class="table table-striped responsive nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> <?php echo e($especialidade->name); ?></td>
                                                        <td> <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                            <h2 style="display: none;"><?php echo e($id = $especialidades_id[0]->dentista_id."-".$especialidade->id); ?></h2>
                                                            <a href="/desvincularESP/<?php echo e($id); ?>" class="btn btn-danger " ><span class="glyphicon glyphicon-remove"></span>Desvincular</a>
                                                          </div></td>
                                                    </tr>
...
</body><?php /**PATH C:\xampp\htdocs\crudDentistas1\resources\views/listaEspecialidadesATB.blade.php ENDPATH**/ ?>