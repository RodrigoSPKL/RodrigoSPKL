                            ...
                            <div class="row">
                                ...
                                <div class="card shadow mb-1 col-sm-12">
                                    <div class="card-header py-2 px-8">
                                        <h6 class="m-0 font-weight-bold text-primary">Editar Especialidade</h6>
                                    </div>
                                        <div class="card-body">
                                            <!--Espaço para a listagem de Titular-->
                                         
                                        <form enctype="multipart/form-data" class="user" method="POST" action="/editar-especialidade/<?php echo e($Especialidade->id); ?>">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" id="nome" name="nome" value="<?php echo e($Especialidade->name); ?>" required="" >
                                                </div>                                   
                                            </div>
...
<?php /**PATH C:\xampp\htdocs\crudDentistas1\resources\views/editEspecialidade.blade.php ENDPATH**/ ?>